...
<style lang="scss" scoped>
    ...
    .lowerPart{
        &__form{
            ...
            &-input{
                padding: 1.8vmin 0 1.8vmin 2vmin;
                font-size: 0.9em;
                border: none;
                border-radius: 1.2em;
                background-color: lighten($color: $back, $amount: 15);
            ...
            &-login{
                ...
                border: none;
                border-radius: 1.2em;
                border: 1px solid lighten($back, 60);
