  ...
  i18n: {
    strategy: "no_prefix",
      ...
      {name:"English", flag:"gb", code: "en"},
                ...
                {name:"Arabic", flag:"ae", code: "ar"},
                {name:"Bangla", flag:"bd", code: "bn"},
                {name:"Chinese", flag:"cn", code: "zh"},
                {name:"Dutch", flag:"bq", code: "nl"},
                {name:"Filipino", flag:"ph", code: "fil"},
